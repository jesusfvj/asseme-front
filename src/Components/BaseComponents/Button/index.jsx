export const Button = ({
  ...
  const finalClassName = `w-full h-full one font-semibold centered flex inline-flex gap-2 justify-center items-center cursor-pointer transition ${sizes[size]} ${buttonColors[color][type]} ${disabledClass} hover:${buttonColors[color][type]}/80 active:scale-[0.995] active:translate-y-[0.5px]`;
  return (
    isLabel ?
